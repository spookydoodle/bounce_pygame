...
class Obstacle(pygame.sprite.Sprite):
    ...
    def is_to_the_right(self, other_rect):
        ...
        """
        return self.rect.right > other_rect.right and self.rect.right > other_rect.left and self.rect.top < other_rect.bottom and self.rect.bottom > other_rect.top

    def is_to_the_left(self, other_rect):
        """
        Checks if `self` is located to the left of `other_rect`, regardless of the distance
        """
        return self.rect.left < other_rect.left and self.rect.left < other_rect.right and self.rect.top < other_rect.bottom and self.rect.bottom > other_rect.top
    ...
    def is_colliding_right(self, other_rect):
        ...
        """
        return self.rect.right >= other_rect.left and self.rect.right <= other_rect.right and \
            self.rect.bottom <= other_rect.bottom and self.rect.bottom >= other_rect.top
    ...
    def is_colliding_left(self, other_rect):
        ...
        """
        return self.rect.left <= other_rect.right and self.rect.left >= other_rect.left and \
            self.rect.bottom <= other_rect.bottom and self.rect.bottom >= other_rect.top